        ...
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <select onchange="atualizarStatus(<?php echo $ag['id']; ?>, this.value, this)" class="status-select">
...
<script>
async function atualizarStatus(id, novoStatus, el) {
    ...
    try {
        ...
        const response = await fetch('../api/mudar_status_agendamento.php', {
            method: 'POST',
            body: formData
        });
