...
// 2. VERIFICAÇÃO NOVA: Verifica se o tipo é 'admin'
if (!isset($_SESSION['admin_tipo']) || $_SESSION['admin_tipo'] != 'admin') {

    // Se não for admin (for funcionário), redireciona para uma página que ele PODE ver
    redirect('admin/agendamentos.php'); // <-- Mude para a página inicial do funcionário
    exit; 
}

// ... (resto do seu código do usuarios.php) ...
