...
$total_agendamentos_mes = $resumo['total_agendamentos_mes'];
$total_lavagens_mes = $resumo['total_lavagens_mes'];
$total_lavagens_semana = $resumo['total_lavagens_semana'];
$receita_mensal = $resumo['receita_mensal'];
$receita_semanal = $resumo['receita_semanal'];
$total_clientes = $resumo['total_clientes'];

$servicos_mais_solicitados = $controller->getServicosMaisSolicitados(5);
$dashboard_semanal = $controller->getDashboardSemanal();
$agendamentos_recentes = $controller->getAgendamentosRecentes(10);
